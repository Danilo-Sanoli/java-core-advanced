  ...
  void aggregateThreeOrders() {
    ...
    assertEquals(
        ...
        stats
            .grossTotal()
            .amount()
            .compareTo(io.github.danilooliveira.pricing.model.Money.of(50.00, "BRL").amount()));
    ...
    assertEquals(
        ...
        stats
            .discountTotal()
            .amount()
            .compareTo(io.github.danilooliveira.pricing.model.Money.of(5.00, "BRL").amount()));
    assertEquals(
        0,
        stats
            .netTotal()
            .amount()
            .compareTo(io.github.danilooliveira.pricing.model.Money.of(45.00, "BRL").amount()));
